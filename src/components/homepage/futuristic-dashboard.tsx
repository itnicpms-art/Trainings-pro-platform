...
export function FuturisticDashboard({ translations: t }: { translations: Dictionary["home"]["dashboard"] }) {
  return (
    <div className="relative mx-auto w-full max-w-[560px] lg:ml-auto xl:max-w-[600px] 2xl:max-w-[640px]">
      ...
      <div className="relative rotate-[0.5deg] rounded-[2rem] border border-white/80 bg-white/55 p-2 shadow-[0_35px_110px_rgba(21,47,118,0.24)] backdrop-blur-2xl sm:p-3">
        <div className="flex min-h-[440px] overflow-hidden rounded-[1.55rem] border border-slate-900/10 bg-[#081334] text-white sm:min-h-[460px] xl:min-h-[485px] 2xl:min-h-[520px]">
