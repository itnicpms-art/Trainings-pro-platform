...
import type { AcademicStructureManagementOverview, AcademicUnitsEditorOverview } from "@/types/database";

type MutationAction = (state: AcademicUnitActionState, formData: FormData) => Promise<AcademicUnitActionState>;

export function AcademicStructureView({ locale, overview, translations: t, editorOverview, editorAction }: { locale: Locale; overview: AcademicStructureManagementOverview; translations: Dictionary["app"]["structureManagement"]; editorOverview?: AcademicUnitsEditorOverview | null; editorAction?: MutationAction }) {
