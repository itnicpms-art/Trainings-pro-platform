...
import type { AcademicCalendarEditorOverview, AcademicGroupsEditorOverview, AcademicProgramsEditorOverview, AcademicStructureManagementOverview, AcademicUnitsEditorOverview, StudentGroupMembershipEditorOverview } from "@/types/database";
...
export function AcademicStructureView({
  ...
  membershipEditorOverview?: StudentGroupMembershipEditorOverview | null;
