...
export default async function MemberDashboardPage({ params }: { params: LocaleParams }) {
  ...
  return <AdaptiveDashboard locale={locale} translations={dictionary.app.dashboardShell} variant={context.variant} profile={context.activeProfile} profileLabel={profileLabel} statusLabel={statusLabel} activeProfileCount={context.activeProfileCount} organizationCount={context.organizationCount} hasAcademicContext={context.hasAcademicContext} canAccessPlatformAdmin={context.canAccessPlatformAdmin} />;
}
