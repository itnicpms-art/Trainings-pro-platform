  ...
  return (
    <main className="min-h-screen overflow-hidden bg-white">
      ...
      <section className="relative isolate overflow-hidden">
        ...
        <div className="mx-auto grid min-h-[calc(100svh-4rem)] max-w-[1400px] items-center gap-10 px-5 py-12 lg:grid-cols-[0.84fr_1.16fr] lg:gap-8 lg:px-8 lg:py-8 xl:gap-12 xl:py-10">
          <div className="relative z-10 max-w-2xl">
            ...
            <h1 className="mt-5 text-[clamp(3.35rem,6vw,6.4rem)] font-semibold leading-[1.03] tracking-[-0.055em] text-[#06102d]">
            ...
            <p className="mt-6 max-w-xl text-base leading-7 text-slate-600 sm:text-lg sm:leading-8 xl:text-xl">{t.hero.subtitle}</p>
            ...
            <div className="mt-8 grid max-w-xl grid-cols-2 gap-x-4 gap-y-4 sm:grid-cols-4">
