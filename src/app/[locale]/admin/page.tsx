...
const summaryMeta = [
  { value: "10", icon: ShieldCheck, color: "text-blue-700 bg-blue-100" },
  { value: "28", icon: KeyRound, color: "text-violet-700 bg-violet-100" },
  { value: "0", icon: Building2, color: "text-cyan-700 bg-cyan-100" },
  { value: "0", icon: UsersRound, color: "text-emerald-700 bg-emerald-100" },
];
